...
from .pathsfinding import main as pathsfinding


def pathsfinding_cli(args):
    parser = argparse.ArgumentParser("pathsfinding")
    parser.add_argument("path_to_model")
    parser.add_argument("path_to_union_model")
    ...
    pathsfinding(
        args.path_to_model, args.path_to_union_model, args.output_dir, **config
    )
