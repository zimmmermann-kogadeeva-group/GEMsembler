...
class GatheredModels:
    ...
    def __init__(self, dict_of_all_models_with_feature: dict,
                 assembly_id=None, path_final_genome_nt=None, path_final_genome_aa=None,
                 path_to_db=None, custom_model_type=None):
        ...
        if not assembly_id and not path_final_genome_nt and not path_final_genome_aa:
            print("Warning! No final genome for gene conversion is provided. Gene conversion will not be performed.\n"
        ...
        for k, v in dict_of_all_models_with_feature.items():
            ...
            if strategies.remove_b[v["model_type"]]:
                model_b_removed = curation.removeBtypeExchange(model)
...
if __name__ == '__main__':
    ...
    genes.runGenesConversion(model_type_list, curated_models, input_genomes_names, gapseq_genes_names, ncbi_cds_name,
    ...
    supermodel = creation.runSupermodelCreation(model_type_list, final_m, final_m_not_sel, final_r, final_r_not_sel,
                                                curated_models, bigg_all_m, bigg_all_r, allmet_converted,
                                                allreact_converted, additional_p_m, periplasmic_r)
