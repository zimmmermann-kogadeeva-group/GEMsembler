...
def drawPathway(supermodel, pathway, met_not_int, colorBrewer, name, aminoacids=None, surrounding=False, Nletter=1):
    g = nx.DiGraph()
    ...
    pyvis_graph = Network(width='{}px'.format(wid), height='{}px'.format(hei), directed=True, notebook=False)
